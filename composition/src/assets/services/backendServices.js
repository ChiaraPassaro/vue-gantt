    ...
    tasks: [
      {
        ...
        startDate: now.plus({ days: 2 }).toFormat("yyyy-MM-dd"),
        endDate: now.plus({ days: 10 }).toFormat("yyyy-MM-dd"),
        days: 0,
        offset: 0,
        name: "Lorem Ipsum 1",
      },
      {
        ...
        startDate: now.plus({ days: 4 }).toFormat("yyyy-MM-dd"),
        endDate: now.plus({ days: 6 }).toFormat("yyyy-MM-dd"),
        days: 0,
        offset: 0,
        name: "Lorem Ipsum 2",
      },
      {
        ...
        endDate: now.plus({ days: 1 }).toFormat("yyyy-MM-dd"),
        days: 0,
        offset: 0,
        name: "Lorem Ipsum 3",
      },
      ...
      },
      {
        ...
        startDate: now.plus({ days: 10 }).toFormat("yyyy-MM-dd"),
        endDate: now.plus({ days: 15 }).toFormat("yyyy-MM-dd"),
        days: 0,
        offset: 0,
        name: "Lorem Ipsum 5",
      },
    ...
    tasks: [
      {
        ...
        startDate: now.plus({ days: 1 }).toFormat("yyyy-MM-dd"),
        endDate: now.plus({ days: 2 }).toFormat("yyyy-MM-dd"),
        days: 0,
        offset: 0,
        name: "Lorem Ipsum 1",
      },
      ...
      },
      {
        ...
        startDate: now.plus({ days: 14 }).toFormat("yyyy-MM-dd"),
        endDate: now.plus({ days: 16 }).toFormat("yyyy-MM-dd"),
        days: 0,
        offset: 0,
        name: "Lorem Ipsum 3",
      },
      {
        ...
        startDate: now.plus({ days: 24 }).toFormat("yyyy-MM-dd"),
        endDate: now.plus({ days: 26 }).toFormat("yyyy-MM-dd"),
        days: 0,
        offset: 0,
        name: "Lorem Ipsum 4",
      },
      {
        ...
        startDate: now.plus({ days: 34 }).toFormat("yyyy-MM-dd"),
        endDate: now.plus({ days: 36 }).toFormat("yyyy-MM-dd"),
        days: 0,
        offset: 0,
        name: "Lorem Ipsum 5",
      },
...
const api = {
  ...
  Tasks: {
    ...
    removeTask: (task, group) => {
      Tasks[group].tasks = Tasks[group].tasks.filter(
    ...
    updateTask: (task, group) => {
      const index = Tasks[group].tasks.findIndex(
        (element) => element.id === task.id
      );
